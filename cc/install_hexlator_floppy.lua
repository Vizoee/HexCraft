...
local viz_raw_url = "https://raw.githubusercontent.com/Vizoee/HexCraft/main/cc/"
...
shell.execute("wget", viz_raw_url.."hexlator.lua", install_path.."hexlator.lua")
shell.execute("wget", viz_raw_url.."hexget.lua", install_path.."hexget.lua")
...
file.write(string.format('shell.setAlias("hexget", "%shexget.lua") shell.setAlias("github", "%sgithub.lua")', install_path, install_path))
file.close()
